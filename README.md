...
Test your `cloudlens` command with:
```
./cloudlens -run tests/good/apples.lens -log tests/good/apples.log
```
...
or in the `./notebooks/travis.log`.

This tutorial is available as a notebook (`./notebooks/tutorial.json`) that you can open in Zeppelin.
